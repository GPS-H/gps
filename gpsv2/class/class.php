...
class Consultar_Alumno{
	...
	function __construct($codigo){
		$this->consulta = mysql_query("SELECT * FROM usuario WHERE id_usuario='$codigo'");
...
class Consultar_Carrera{
	...
	function __construct($codigo){
		$this->consulta = mysql_query("SELECT * FROM usuario WHERE id_usuario='$codigo' or usuario='$codigo' or nombre='$codigo'");
		$this->fetch = mysql_fetch_array($this->consulta);
	}
...
class Consultar_Profesor{
	...
	function __construct($codigo){
		$this->consulta = mysql_query("SELECT * FROM usuario WHERE usuario='$codigo'");
		$this->fetch = mysql_fetch_array($this->consulta);
	}
